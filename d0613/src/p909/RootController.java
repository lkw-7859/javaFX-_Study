...
public class RootController implements Initializable{
	...
	public void initialize(URL location, ResourceBundle resources) {
		listView.setItems(FXCollections.observableArrayList("°¶·°½ÃS1","°¶·°½ÃS2","°¶·°½ÃS3","°¶·°½ÃS4","°¶·°½ÃS5","°¶·°½ÃS6","°¶·°½ÃS7"));
	...
	public void handleBtnOkAction(ActionEvent e) {
		...
		System.out.println("TableVuew ½º¸¶Æ®Æù: "+phone.getSmartPhone());
		System.out.println("TableVuew ÀÌ¹ÌÁö: "+phone.getImage());
	}
